...
ROLES: tuple[RoleSpec, ...] = (
    RoleSpec("extract", "EXTRACT", "LLM-функция извлечения"),
    RoleSpec("keyword", "KEYWORD", "LLM-функция ключевых слов"),
    RoleSpec("query", "QUERY", "LLM-функция запросов"),
    RoleSpec("vlm", "VLM", "LLM-функция VLM"),
)
