...
import ChatsView from '@/features/ChatsView'
          ...
          <main className="flex h-screen w-screen overflow-hidden">
            ...
            >
              ...
              <div className="relative grow">
                ...
                <TabsContent value="chats" className="absolute top-0 right-0 bottom-0 left-0 overflow-auto">
                  <ChatsView />
                </TabsContent>
                <TabsContent value="admin-users" className="absolute top-0 right-0 bottom-0 left-0 overflow-auto">
                  <AdminUsersView />
                </TabsContent>
                <TabsContent value="documentation" className="absolute top-0 right-0 bottom-0 left-0 overflow-hidden">
                  <Documentation />
                </TabsContent>
                <TabsContent value="settings" className="absolute top-0 right-0 bottom-0 left-0 overflow-hidden">
                  <SettingsPage />
                </TabsContent>
              </div>
            </Tabs>
            {/* Индикатор состояния теперь в шапке (SiteHeader), слева. */}
